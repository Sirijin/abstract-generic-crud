...
import com.example.demo.variant_1.abstract_crud.other.EntityEvent;
import com.example.demo.variant_1.abstract_crud.mapper.CallbackMapper;
...
import com.example.demo.variant_1.abstract_crud.repository.CrudRepo;
import com.example.demo.variant_1.abstract_crud.other.CrudUtils;
...
public abstract class AbstractCrudService<
    ...
    public Optional<E> update(final ID id, final E source) {
        return repository.update(id, source, (s, e) -> CrudUtils.copyNonNullProperties(s, e, ignoredProps()))
                .map(entity -> {
